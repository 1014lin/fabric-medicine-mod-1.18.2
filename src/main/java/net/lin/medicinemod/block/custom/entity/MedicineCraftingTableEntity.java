...
import net.lin.medicinemod.recipe.MedicineCraftingTableRecipe;
...
public class MedicineCraftingTableEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public MedicineCraftingTableEntity(BlockPos pos, BlockState state) {
        ...
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                switch (index) {
                    case 0: return MedicineCraftingTableEntity.this.progress;
                    case 1: return MedicineCraftingTableEntity.this.maxProgress;
                    case 2: return MedicineCraftingTableEntity.this.fuelTime;
                    case 3: return MedicineCraftingTableEntity.this.maxFuelTime;
                    default: return 0;
                }
            }
            ...
            public void set(int index, int value) {
                switch(index) {
                    case 0: MedicineCraftingTableEntity.this.progress = value; break;
                    case 1: MedicineCraftingTableEntity.this.maxProgress = value; break;
                    case 2: MedicineCraftingTableEntity.this.fuelTime = value; break;
                    case 3: MedicineCraftingTableEntity.this.maxFuelTime = value; break;
                }
            }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory inv, PlayerEntity player) {
        return new MedicineCraftingTableScreenHandler(syncId, inv, this, this.propertyDelegate);
    }
    ...
    private static boolean hasFuelInFuelSlot(MedicineCraftingTableEntity entity) {
        return !entity.getStack(0).isEmpty();
    }

    private static boolean isConsumingFuel(MedicineCraftingTableEntity entity) {
    ...
    private static boolean hasRecipe(MedicineCraftingTableEntity entity) {
        ...
        Optional<MedicineCraftingTableRecipe> match = world.getRecipeManager()
                .getFirstMatch(MedicineCraftingTableRecipe.Type.INSTANCE, inventory, world);
